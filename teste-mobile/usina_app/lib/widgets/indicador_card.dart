        ...
        child: Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              ...
              Expanded(child: Text(indicador.nome, style: const TextStyle(color: Color(0xffe8f3e2), fontSize: 13, fontWeight: FontWeight.w600))),
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
              ...
              Padding(padding: const EdgeInsets.only(bottom: 2), child: Text(indicador.tipoInformacao.unidadeMedida.simbolo, style: const TextStyle(color: Color(0xffb7c3bd), fontSize: 13))),
              const Spacer(),
              Column(crossAxisAlignment: CrossAxisAlignment.end, children: [const Text('meta', style: TextStyle(color: Color(0xff9aa9a1), fontSize: 10)), const SizedBox(height: 3),               Text('${indicador.metaValor.toStringAsFixed(0)} ${indicador.tipoInformacao.unidadeMedida.simbolo}', style: const TextStyle(color: Color(0xffdcebd5), fontSize: 12, fontWeight: FontWeight.w600))]),
            ]),
            ...
            Row(children: [const Icon(Icons.factory_outlined, size: 12, color: Color(0xff90a198)), const SizedBox(width: 5), Expanded(child: Text('${medicao.equipamento.unidade.usina.nome}  ›  ${medicao.equipamento.unidade.nome}  ›  ${medicao.equipamento.nome}', overflow: TextOverflow.ellipsis, style: const TextStyle(color: Color(0xff90a198), fontSize: 10)))]),
            const SizedBox(height: 6),
            Row(children: [const Icon(Icons.schedule_outlined, size: 13, color: Color(0xff90a198)), const SizedBox(width: 5), Text(_formatDate(medicao.data), style: const TextStyle(color: Color(0xff90a198), fontSize: 10)), const Spacer(), Flexible(child: Text(indicador.descricao, overflow: TextOverflow.ellipsis, style: const TextStyle(color: Color(0xff9aa9a1), fontSize: 10)))]),
          ]),
        ),
      ),
    );
