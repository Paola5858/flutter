...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: Drawer(
        width: 326,
        backgroundColor: AppColors.mineralRaised,
        child: _MenuPrincipal(
          ...
          onItemSelected: (item) async {
            ...
            if (item == 'indicador') {
              ...
              if (!context.mounted || indicador == null) return;
                ...
                SliverPadding(
                  ...
                  sliver: SliverList(
                    delegate: SliverChildListDelegate([
                      ...
                      _SummaryCard(
                        resumo: resumo,
                        total: widget.dashboard.medicoes.length,
                      ),
                      const SizedBox(height: 28),
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            '${medicoes.length.toString().padLeft(2, '0')} sinais',
                      ...
                      if (medicoes.isEmpty)
                        ...
                        ...medicoes.map((medicao) {
                          final indicador = widget.dashboard.indicadores
                              .firstWhere(
                                (item) =>
                                    item.tipoInformacao.id ==
                                    medicao.tipoInformacao.id,
                              );
                          return Padding(
        ...
        child: ListView(
          ...
          children: [
            ...
            AnimatedCrossFade(
              ...
              crossFadeState: cadastroAberto
                  ? CrossFadeState.showFirst
                  : CrossFadeState.showSecond,
              firstChild: Padding(
                padding: const EdgeInsets.only(left: 12, top: 8),
                child: Column(
                  children: itensCadastro
                      .map(
                        (item) => _MenuSubItem(
                          icon: item.$2,
                          label: item.$1,
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: const Color(0xffb8d5a8).withValues(alpha: .14),
                ),
              ),
              child: const Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'cada dado conta uma história do campo.',
                      style: TextStyle(
            ...
            const Text(
              'usina aurora  ·  safra 2026',
              style: TextStyle(color: Color(0xff718079), fontSize: 10),
            ),
          ],
        ),
      ),
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: const Column(
      ...
      children: [
        ...
        SizedBox(height: 5),
        Text(
          'controle claro para decisões melhores.',
          style: TextStyle(color: Color(0xffc6dec1), fontSize: 11),
        ),
      ],
    ),
  );
...
class _MenuItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ListTile(
    ...
    tileColor: selected
        ? const Color(0xffb8d5a8).withValues(alpha: .13)
        : Colors.transparent,
    leading: Icon(
      icon,
      color: selected ? const Color(0xffc7e1b9) : const Color(0xff90a198),
      size: 21,
    ),
    title: Text(
      label,
      style: TextStyle(
        color: selected ? const Color(0xffe8f3e2) : const Color(0xffb7c3bd),
        fontSize: 13,
...
class _MenuSubItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ListTile(
    ...
    leading: Icon(
      icon,
      color: selected ? const Color(0xffb8d5a8) : const Color(0xff6e7f76),
      size: 17,
    ),
    title: Text(
      label,
      style: TextStyle(
        color: selected ? const Color(0xffdcebd5) : const Color(0xff9aa9a1),
        fontSize: 12,
      ),
    ),
    trailing: selected
        ? const Icon(Icons.circle, color: Color(0xffb8d5a8), size: 6)
        : null,
  );
}
    ...
    child: Stack(
      children: [
        Positioned(
          top: -80,
          right: -45,
          child: _Glow(size: 210, color: Color(0xff8bb77f)),
        ),
        Positioned(
          top: 420,
          left: -105,
          child: _Glow(size: 250, color: Color(0xff456b4f)),
        ),
      ],
    ),
  );
  ...
  Widget build(BuildContext context) => Row(
    children: [
      ...
      Container(
        ...
        decoration: BoxDecoration(
          color: const Color(0xffb8d5a8).withValues(alpha: .12),
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
            color: const Color(0xffb8d5a8).withValues(alpha: .22),
          ),
        ),
        child: Row(
          children: [
...
class _Intro extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(
    ...
    children: [
      const Text(
        'bom dia, operação.',
        style: TextStyle(color: Color(0xffe8f3e2), fontSize: 14),
      ),
      ...
      Row(
        children: [
          ...
          const SizedBox(width: 7),
          Text(
            '${safra.nomeSafra}  ·  ${safra.diasRestantes()} dias restantes',
            style: const TextStyle(color: Color(0xff9aa9a1), fontSize: 12),
          ),
        ],
      ),
    ],
                  ...
                  child: Center(
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        fontWeight: FontWeight.w600,
                        color: value == item
                            ? const Color(0xff261722)
                            : const Color(0xffb7c3bd),
                      ),
                    ),
                  ),
                ),
            ...
            Row(
              children: [
                _StatusPill(
                  ...
                  value: resumo[StatusIndicador.dentroMeta] ?? 0,
                  color: const Color(0xff91dfb7),
                ),
                _StatusPill(
                  label: 'atenção',
                  value: resumo[StatusIndicador.atencao] ?? 0,
                  color: const Color(0xfff2c476),
                ),
                _StatusPill(
                  label: 'fora',
                  value: resumo[StatusIndicador.foraMeta] ?? 0,
                  color: const Color(0xffec8fa9),
                ),
              ],
            ),
          ],
  ...
  Widget build(BuildContext context) => Expanded(
    child: Column(
      ...
      children: [
        ...
        Text(
          label,
          style: const TextStyle(color: Color(0xffb9acb8), fontSize: 10),
        ),
      ],
    ),
  );
...
class _EmptyPeriodState extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: const Column(
      children: [
        Icon(Icons.query_stats_rounded, color: AppColors.inkMuted, size: 28),
        ...
        Text(
          'selecione outro período para acompanhar os sinais disponíveis.',
